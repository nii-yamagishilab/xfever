...
class BaseTransformer(pl.LightningModule):
    ...
    def add_model_specific_args(parser):
        ...
        parser.add_argument("--consistency_loss_func1", type=str)
        parser.add_argument("--consistency_loss_func2", type=str)
        parser.add_argument("--lambda_ori", type=float, default=0.0)
